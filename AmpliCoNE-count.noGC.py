...
#NOTE: E. Kopania 19 Jan 2021 - Comment out GC correction
import sys
import re
import pandas
import numpy
...
parser.add_argument('--CHR', '-c', required=True, help=' Chromosome annotation as found in the BAM header file. ', choices=['Y','chrY','X','chrX'])
...
#
##GC correction step
GCcor_Summary_data=Summary_data.copy() #Leave uncommented to just copy Summary data w/ no GC correction for downstream analyses
#for i in range(1,100):
